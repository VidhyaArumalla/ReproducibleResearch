...
Median of total number of steps taken per day = `r median`
...
```
5-minute interval, on average across all the days in the dataset, containing the maximum number of steps is `r maxintervalval4maxmean`
...
```
The total number of missing values in the dataset is `r totalrows`
